...
class ProfDetail2 extends StatefulWidget {
...
//        _currentUser = currentUser,
  ...
  @override
  _ProfDetail2State createState() => _ProfDetail2State();
}

class _ProfDetail2State extends State<ProfDetail2> {
...
//                      _buildPhotosFront(), //プロフの画像
  ...
  Widget _buildPhotosFront() {
    Size size = MediaQuery.of(context).size;
    return (_searchUser.photo2 != null &&
            _searchUser.photo2 != '') //前の残骸でphoto=''のやつもある今度リセットする
        ? Container(
            height: size.height * 0.5,
            child: Stack(
              children: <Widget>[
                PhotoIndicator(
                  photo: _searchUser.photo2,
