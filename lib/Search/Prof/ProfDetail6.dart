...
class ProfDetail6 extends StatefulWidget {
...
//        _currentUser = currentUser,
  ...
  @override
  _ProfDetail6State createState() => _ProfDetail6State();
}

class _ProfDetail6State extends State<ProfDetail6> {
...
//                      _buildPhotosFront(), //プロフの画像
  ...
  Widget _buildPhotosFront() {
    Size size = MediaQuery.of(context).size;
    return (_searchUser.photo6 != null &&
            _searchUser.photo6 != '') //前の残骸でphoto=''のやつもある今度リセットする
        ? Container(
            height: size.height * 0.5,
            child: Stack(
              children: <Widget>[
                PhotoIndicator(
                  photo: _searchUser.photo6,
