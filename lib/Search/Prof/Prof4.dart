...
//    this.callback,
  ...
  @override
  _Prof4State createState() => _Prof4State();
}
...
//    firstBuild = true;
  ...
  Widget _buildDecisionIndicator() {
    Size size = MediaQuery.of(context).size;
    print('_buildDecisionIndicator');
    print('widget.decision: ${widget.swipeDecision}');
...
//      }
  ...
  Widget _buildPhotosFront() {
    ...
    print('_searchUser.uid: ${_searchUser.uid}');
    return (_searchUser.photo4 != null &&
            _searchUser.photo4 != '') //前の残骸でphoto=''のやつもある今度リセットする
        ? PhotoIndicator(
            photo: _searchUser.photo4,
            photoNumber: 4,
